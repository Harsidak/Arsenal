...
> [!NOTE] Source Context
> This is where the math starts to get incredibly powerful. You are stepping out of basic vector arithmetic (from [[ME/MATHEMATICS/Diseroth Notes/Linear Algebra/Vector Spaces]]) and into the machinery adapted from [[BOOK - MATHEMATICS FOR MACHINE LEARNING (Deisenroth)]] that allows an AI to compare complex data.
